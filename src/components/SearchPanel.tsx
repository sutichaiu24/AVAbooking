  ...
  return (
    <section>
      <div className="flex items-baseline justify-between gap-6 border-b border-aa-border pb-4">
        <h2 className="text-[28px] font-light tracking-tight">ค้นหาเที่ยวบินภายในประเทศ</h2>
        <p className="hidden text-[15px] font-light text-aa-muted sm:block">
      ...
      >
        ...
        <div className="pt-4 sm:col-span-2 lg:col-span-5">
          ...
          <p className="mt-6 text-[15px] font-light leading-relaxed text-aa-muted">
            {AIRPORTS[query.origin].nameTh} → {AIRPORTS[query.destination].nameTh} ·
            ราคาทั้งหมดแสดงเป็นเงินบาท รวมภาษีมูลค่าเพิ่มแล้ว
          </p>

          {error && (
            <p role="alert" className="mt-4 border-l-2 border-aa-red pl-4 text-[16px] text-aa-crimson">
              {error}
            </p>
          )}
        </div>
