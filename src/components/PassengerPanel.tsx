  ...
  return (
    <section>
      <div className="border-b border-aa-border pb-4">
        <h2 className="text-[28px] font-light tracking-tight">ข้อมูลผู้โดยสาร</h2>
        <p className="mt-2 text-[15px] font-light text-aa-muted">
      ...
      <p className="flex items-start gap-2.5 border-t border-aa-border pt-5 text-[13px] font-light leading-relaxed text-aa-muted">
...
function Field({
  ...
  return (
    <div className={className}>
      ...
      />
      {error && <p className="mt-1.5 text-[13px] font-medium text-aa-red">{error}</p>}
    </div>
  );
}
